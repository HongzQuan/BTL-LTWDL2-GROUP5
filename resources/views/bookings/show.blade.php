...
<div class="container py-4">
    ...
    <nav aria-label="breadcrumb" class="mb-4 mt-2">
        <ol class="breadcrumb bg-transparent p-0 m-0">
            ...
            <li class="breadcrumb-item">
                <a href="{{ route('profile') }}" class="text-decoration-none text-muted transition-all link-hover-danger">Lịch sử đặt bàn</a>
            </li>
            <li class="breadcrumb-item active fw-bold text-dark" aria-current="page">
                #{{ sprintf('%05d', $booking->id) }}
            </li>
        </ol>
    </nav>
        ...
        <div class="col-lg-8">
            ...
            <div class="card border-danger border-opacity-50 rounded-3 mb-4">
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('bookings.cancel', $booking->id) }}" method="POST" onsubmit="return confirm('Bạn có chắc chắn muốn hủy đơn đặt bàn này không? Hành động này không thể hoàn tác.');">
                        @csrf
                        @method('PUT')

                        <div class="mb-3">
                            <label class="form-label text-danger fw-semibold">Lý do hủy <span class="text-muted fw-normal">(Không bắt buộc)</span></label>
                            <textarea name="cancel_reason" class="form-control" rows="3" placeholder="Nhập lý do hủy đặt bàn..."></textarea>
                        </div>

                        <button type="submit" class="btn btn-outline-danger w-100 fw-bold">
                            <i class="bi bi-x-circle me-2"></i> Hủy đặt bàn này
                        </button>
                    </form>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow-sm border-0 rounded-3 mb-4 sticky-top" style="top: 80px">
                ...
                <div class="card-footer bg-white border-top p-4 d-grid gap-2">
                    <a href="{{ route('restaurants.show', $booking->restaurant_id) }}" class="btn btn-outline-primary w-100 mb-2">
                        <i class="bi bi-shop me-2"></i> Xem nhà hàng
                    </a>
