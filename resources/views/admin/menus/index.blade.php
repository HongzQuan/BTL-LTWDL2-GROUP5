...
.toggle-switch.loading .toggle-slider    { opacity: .5; pointer-events: none; }
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge px-2 py-1
                                    @switch($item->type)
                                        @case('food')    bg-success  @break
                                        @case('drink')   bg-info     @break
                                        @case('dessert') bg-warning text-dark @break
                                        @case('combo')   bg-primary  @break
