...
{
    /**
     * Xác định người dùng có quyền gọi request này hay không.
     */
    ...
    public function rules(): array
    {
        return [
            ...
            // Logic nâng cao: Bàn bắt buộc phải tồn tại và phải thuộc về restaurant_id đang đặt
            'table_id' => [
                'required',
    ...
    public function messages(): array
    {
        return [
            ...
            'table_id.exists'        => 'Bàn đã chọn không tồn tại, đã bị xóa hoặc không thuộc nhà hàng này.',
