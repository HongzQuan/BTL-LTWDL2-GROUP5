...
<div class="container py-4">
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <!-- Đánh giá tổng quan (Đã được cấu trúc lại rất đẹp bằng Bootstrap) -->
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-md-4 text-center border-end">
                            ...
                            @endphp
                            <h2 class="display-4 fw-bold text-warning mb-0">{{ number_format($averageRating, 1) }}</h2>
                ...
                <div class="tab-content py-4" id="restaurantTabContent">
                    ...
                    <div class="tab-pane fade" id="info" role="tabpanel">
                        ...
                        <ul class="list-group list-group-flush mb-4">
                            <li class="list-group-item px-0"><strong>📍 Địa chỉ:</strong> {{ $restaurant->address }}</li>
                            <li class="list-group-item px-0"><strong>📞 Số điện thoại:</strong> {{ $restaurant->phone }}</li>
                ...
                <div class="card shadow-sm sticky-top" style="top: 80px; z-index: 1020;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center py-4">
                            ...
                            <a href="{{ route('login') }}" class="btn btn-outline-danger w-100 fw-bold">ĐĂNG NHẬP</a>
                        </div>
                        @endauth
                    </div>
                </div>
